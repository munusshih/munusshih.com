...
tags:
  ...
  - "Tool"
startDate: "2022"
heroImage: "/assets/work/layers/1.jpeg"
images: ["/assets/work/layers/2.jpeg", "/assets/work/layers/2.gif"]
archived: true
---
...
<div>
  <Media src="/assets/work/layers/2.jpeg" isVideo={false} />
...
<div>
  <Media src="/assets/work/layers/3.jpeg" isVideo={false} />
  The project was made in response to the pandemic and the freelancing shift in
  the current design landscape.
</div>

<div>
  <Media src="/assets/work/layers/1.gif" isVideo={false} />
</div>
<Media src="/assets/work/layers/5.jpeg" isVideo={false} />
<div>
  <Media src="/assets/work/layers/6.jpg" isVideo={false} />
...
<div>
  <Media src="/assets/work/layers/2.gif" isVideo={false} />
  Participants' answers influence the cubes’ amount, color, size, and gravity —
  for example, here preferring in-person work increases gravitational pull.
</div>
