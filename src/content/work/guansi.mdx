...
tags:
  ...
  - "Installation"
startDate: "Sep 2024"
heroImage: "/assets/work/guansi/scene.mp4"
images: ["/assets/work/guansi/map.png", "/assets/work/guansi/cover.jpg"]
---

import Media from "@/components/utils/Media.astro";

<div>
  <Media src="/assets/work/guansi/guansi.png" isVideo={false} />
</div>

<div>
  <Media src="/assets/work/guansi/website.mp4" isVideo={true} />
  People can go to the website to read other people's stories of migration and
  coming home.
</div>

<div>
  <Media src="/assets/work/guansi/exhibition1.jpg" isVideo={false} />

</div>

<div>
  <Media src="/assets/work/guansi/research.jpg" isVideo={false} />
...
<div>
  <Media src="/assets/work/guansi/code.mp4" isVideo={true} />
  We developed a generative system using code to create a unique house for each
  data point.
</div>

<div>
  <Media src="/assets/work/guansi/data.mp4" isVideo={true} />
</div>

<div>
  <Media src="/assets/work/guansi/exhibition2.jpg" isVideo={false} />
</div>

<div>
  <Media src="/assets/work/guansi/installation.mp4" isVideo={true} />
</div>

<Media src="/assets/work/guansi/process.jpg" isVideo={false} />

<div>
  <Media src="/assets/work/guansi/process-2.mp4" isVideo={true} />
</div>
